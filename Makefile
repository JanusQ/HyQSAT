...
# Target file names
MINISAT      = minisat_core#       Name of MiniSat main executable.
...
r:	$(BUILD_DIR)/release/bin/$(MINISAT_CORE)
d:	$(BUILD_DIR)/debug/bin/$(MINISAT_CORE)
p:	$(BUILD_DIR)/profile/bin/$(MINISAT_CORE)
sh:	$(BUILD_DIR)/dynamic/bin/$(MINISAT_CORE)
